    ...
    <>
      <IconContext.Provider value={{ color: '#18287b' }}>
        <div className='navbar'>
          ...
          <Col xs = {8} ><Link to='#' className=' fs-1_5 setting float-right border-right border-left pl-3 pr-3 '>
          <MdIcons.MdSettings/>
              </Link>
          </Col>
          <Col>
          ...
          <Col >
          <Button style = {{backgroundColor:" #18287b"}}>
            Actions
          </Button>
          </Col>
          </Row>
        </div>
        <nav className={sidebar ? 'nav-menu active z-index-2 border-right' : 'nav-menu'}>
